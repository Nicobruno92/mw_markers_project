...
df_ot_contrasts = df_all_probe.query(f"comparison in {ot_contrasts}").query("balance == 'unbalance'")
...
df_ot= df_all_probe.query("balance == 'unbalance'").query(f"markers in {['t_n_mean', 't_n_std', 't_mean', 't_std']}") #, 'p_e_8_mean', 'p_e_8_std', 'wSMI_8_mean', 'wSMI_8_std'
...
df_off_contrasts = df_all_probe.query(f"comparison in {off_contrasts}").query("balance == 'unbalance'")
