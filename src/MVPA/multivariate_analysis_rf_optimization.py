...
for comparison in comparisons:
    ...
    for k in folds_list:
        ...
        study_db_path = os.path.join(results_path, 'multivariate_rf_augmented_study.db')
        ...
        importances_df.to_csv(os.path.join(results_path, f'rf_feat_imp_{comparison}_{probe}_K{k}_augmented.csv'))

        RM_optimization.plot_feat_importances(filename = os.path.join(fig_path, f'rf_{comparison}_feat_importance_{probe}_K{k}_augmented.png'), feature_names = features, color = pink, show= False,  save_fig = True)