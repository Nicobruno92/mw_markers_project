...
for comparison in comparisons:
    ...
    for k in folds_list:
        ...
        study = optuna.load_study(study_name= f'{comparison}_{probe}_K{k}_6', storage=f'sqlite:///{study_db_path}')
        ...
        results_df.to_csv(os.path.join(results_path, f'permutations_{comparison}_{probe}_K{k}.csv'))