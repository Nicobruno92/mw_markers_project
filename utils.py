...
def correct_name_markers(df):
    ...
    'P3b':r'$P3b$',
    ###mean###
    'd_mean':r'$\delta_{mean}$', 
    'd_n_mean':r'$|\delta|_{mean}$',
    't_mean':r'$\theta_{mean}$', 
    't_n_mean':r'$|\theta|_{mean}$',
    'a_mean':r'$\alpha_{mean}$', 
    'a_n_mean':r'$|\alpha|_{mean}$',
    'b_mean':r'$\beta_{mean}$', 
    'b_n_mean':r'$|\beta|_{mean}$',
    'g_mean':r'$\gamma_{mean}$', 
    'g_n_mean':r'$|\gamma|_{mean}$',
    'p_e_1_mean': r'$PE\gamma_{mean}$',
    'p_e_2_mean': r'$PE\beta_{mean}$',
    'p_e_4_mean': r'$PE\alpha_{mean}$',
    'p_e_8_mean': r'$PE\theta_{mean}$',
    'wSMI_1_mean': r'$wSMI\gamma_{mean}$',
    'wSMI_2_mean': r'$wSMI\beta_{mean}$',
    'wSMI_4_mean': r'$wSMI\alpha_{mean}$',
    'wSMI_8_mean': r'$wSMI\theta_{mean}$', 
    'k_mean':r'$K_{mean}$',
    'se_mean': r'$SE_{mean}$',
    'msf_mean':r'$MSF_{mean}$',
    'sef90_mean': r'$SEF90_{mean}$',
    'sef95_mean': r'$SEF95_{mean}$',
    'CNV_mean': r'$CNV_{mean}$',
    'P1_mean':r'$P1_{mean}$', 
    'P3a_mean':r'$P3a_{mean}$',
    'P3b_mean':r'$P3b_{mean}$',
    ###std###
    'd_std':r'$\delta_{std}$', 
    'd_n_std':r'$|\delta|_{std}$',
    't_std':r'$\theta_{std}$', 
    't_n_std':r'$|\theta|_{std}$',
    'a_std':r'$\alpha_{std}$', 
    'a_n_std':r'$|\alpha|_{std}$',
    'b_std':r'$\beta_{std}$', 
    'b_n_std':r'$|\beta|_{std}$',
    'g_std':r'$\gamma_{std}$', 
    'g_n_std':r'$|\gamma|_{std}$',
    'p_e_1_std': r'$PE\gamma_{std}$',
    'p_e_2_std': r'$PE\beta_{std}$',
    'p_e_4_std': r'$PE\alpha$_{std}',
    'p_e_8_std': r'$PE\theta_{std}$',
    'wSMI_1_std': r'$wSMI\gamma_{std}$',
    'wSMI_2_std': r'$wSMI\beta_{std}$',
    'wSMI_4_std': r'$wSMI\alpha_{std}$',
    'wSMI_8_std': r'$wSMI\theta_{std}$', 
    'k_std':r'$K_{std}$',
    'se_std': r'$SE_{std}$',
    'msf_std':r'$MSF_{std}$',
    'sef90_std': r'$SEF90_{std}$',
    'sef95_std': r'$SEF95_{std}$',
    'CNV_std': r'$CNV_{std}$',
    'P1_std':r'$P1_{std}$', 
    'P3a_std':r'$P3a_{std}$',
    'P3b_std':r'$P3b_{std}$',
...
def change_markers_latex(df, column):
